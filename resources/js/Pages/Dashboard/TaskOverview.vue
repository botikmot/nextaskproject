...
<template>
    <div class="">
        ...
        <template v-else-if="tasksDueToday === 0">
            ...
            <a
                class="absolute bottom-5 right-5 px-6 cursor-pointer hover:scale-105 transition py-3 bg-gradient-to-r from-navy-blue to-sky-blue text-color-white rounded-full hover:from-sky-blue hover:to-navy-blue hover:shadow-lg"
                :href="route('my-tasks', {
                                selectedProjects: data.selectedProjects,
                                selectedStatuses: data.selectedStatuses,
                                sortBy: data.sortBy,
        ...
        <template v-else>
            ...
            <a
                class="absolute bottom-5 right-5 px-6 cursor-pointer py-3 hover:scale-105 transition bg-gradient-to-r from-navy-blue to-sky-blue text-color-white rounded-full hover:from-sky-blue hover:to-navy-blue hover:shadow-lg"
                :href="route('my-tasks', {
                                selectedProjects: data.selectedProjects,
                                selectedStatuses: data.selectedStatuses,
                                sortBy: data.sortBy,
